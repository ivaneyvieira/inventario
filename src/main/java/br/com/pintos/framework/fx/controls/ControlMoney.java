...
public class ControlMoney
  extends ControlFX<Double>
{
  private BigDecimalField control;
  
  public ControlMoney(String paramString)
  {
    super(paramString);
  }
...
/* Location:              /home/ivaneyvieira/git/inventario/Inventario.jar!/br/com/pintos/framework/fx/controls/ControlMoney.class
