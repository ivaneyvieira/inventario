...
/*     */     }
/*     */     
/* 400 */     String urlString = classUrlString.substring(4, classUrlString.lastIndexOf("!"));
...
/* 405 */     JarFile jf = null;
/*     */     try {
/* 407 */       jf = new JarFile(jarName);
/* 408 */       Manifest mf = jf.getManifest();
/* 409 */       return mf.getMainAttributes();
/*     */     } finally {
/* 411 */       if (jf != null) {
/*     */         try {
/* 413 */           jf.close();
...
/*     */         
/* 871 */         public void run() { try { Class componentClass = Class.forName("java.awt.Component");
...
/* Location:              /home/ivaneyvieira/git/inventario/Inventario.jar!/com/javafx/main/Main.class
