...
public enum ColorDef
{
  ...
  private ColorDef(String paramString, Color paramColor)
  {
...
/* Location:              /home/ivaneyvieira/git/inventario/Inventario.jar!/jfxtras/labs/scene/control/gauge/ColorDef.class
