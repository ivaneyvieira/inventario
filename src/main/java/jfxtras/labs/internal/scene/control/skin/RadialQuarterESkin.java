  ...
  extends GaugeSkinBase<RadialQuarterE, RadialQuarterEBehavior>
{
  ...
  public RadialQuarterESkin(RadialQuarterE paramRadialQuarterE)
  {
    super(paramRadialQuarterE, new RadialQuarterEBehavior(paramRadialQuarterE));
    this.control = paramRadialQuarterE;
    ...
    this.ledTimer = new AnimationTimer()
    {
      ...
      {
        if (paramAnonymousLong > RadialQuarterESkin.this.lastLedTimerCall + RadialQuarterESkin.this.getBlinkInterval())
        {
          RadialQuarterESkin.access$180(RadialQuarterESkin.this, 1);
          if (RadialQuarterESkin.this.ledOnVisible) {
            RadialQuarterESkin.this.ledOn.setOpacity(1.0D);
          } else {
            RadialQuarterESkin.this.ledOn.setOpacity(0.0D);
          }
          RadialQuarterESkin.this.lastLedTimerCall = paramAnonymousLong;
        }
      }
    };
    ...
    this.userLedTimer = new AnimationTimer()
    {
      public void handle(long paramAnonymousLong)
      {
        if (paramAnonymousLong > RadialQuarterESkin.this.lastUserLedTimerCall + RadialQuarterESkin.this.getBlinkInterval())
        {
          RadialQuarterESkin.access$480(RadialQuarterESkin.this, 1);
          if (RadialQuarterESkin.this.userLedOnVisible) {
            RadialQuarterESkin.this.userLedOn.setOpacity(1.0D);
          } else {
            RadialQuarterESkin.this.userLedOn.setOpacity(0.0D);
          }
          RadialQuarterESkin.this.lastUserLedTimerCall = paramAnonymousLong;
        }
      }
    };
  ...
  private void addListeners()
  {
    ...
    this.control.valueProperty().addListener(new ChangeListener()
    {
      public void changed(ObservableValue<? extends Number> paramAnonymousObservableValue, Number paramAnonymousNumber1, Number paramAnonymousNumber2)
      {
        ...
        if ((paramAnonymousNumber2.doubleValue() > paramAnonymousNumber1.doubleValue() - RadialQuarterESkin.this.control.getRedrawToleranceValue()) && (paramAnonymousNumber2.doubleValue() < paramAnonymousNumber1.doubleValue() + RadialQuarterESkin.this.control.getRedrawToleranceValue())) {
          return;
        }
        Object localObject1;
        Object localObject2;
        ...
        {
          localObject1 = new KeyValue(RadialQuarterESkin.this.gaugeValue, paramAnonymousNumber2, Interpolator.SPLINE(0.5D, 0.4D, 0.4D, 1.0D));
          localObject2 = new KeyFrame(Duration.millis(RadialQuarterESkin.this.control.getAnimationDuration()), new KeyValue[] { localObject1 });
          RadialQuarterESkin.this.rotationAngleTimeline = new Timeline();
          RadialQuarterESkin.this.rotationAngleTimeline.getKeyFrames().add(localObject2);
        ...
        else
        {
          ...
          RadialQuarterESkin.this.pointerRotation.setAngle((paramAnonymousNumber2.doubleValue() - RadialQuarterESkin.this.control.getMinValue()) * RadialQuarterESkin.this.control.getAngleStep());
          RadialQuarterESkin.this.pointer.getTransforms().add(Transform.rotate(-RadialQuarterESkin.this.control.getRadialRange().ROTATION_OFFSET, RadialQuarterESkin.this.center.getX(), RadialQuarterESkin.this.center.getY()));
          RadialQuarterESkin.this.pointer.getTransforms().add(RadialQuarterESkin.this.pointerRotation);
        }
        RadialQuarterESkin.this.checkMarkers(RadialQuarterESkin.this.control, paramAnonymousNumber1.doubleValue(), paramAnonymousNumber2.doubleValue());
        ...
        if (RadialQuarterESkin.this.control.isSectionsHighlighting())
        {
          ...
          ((DropShadow)localObject2).setWidth(0.05D * RadialQuarterESkin.this.gaugeBounds.getWidth());
          ((DropShadow)localObject2).setHeight(0.05D * RadialQuarterESkin.this.gaugeBounds.getHeight());
          ((DropShadow)localObject2).setBlurType(BlurType.GAUSSIAN);
          localIterator = RadialQuarterESkin.this.control.getSections().iterator();
        ...
        if (RadialQuarterESkin.this.control.isAreasHighlighting())
        {
          ...
          ((DropShadow)localObject2).setHeight(0.05D * RadialQuarterESkin.this.gaugeBounds.getHeight());
          ((DropShadow)localObject2).setBlurType(BlurType.GAUSSIAN);
          localIterator = RadialQuarterESkin.this.control.getAreas().iterator();
          while (localIterator.hasNext())
          {
            localSection = (Section)localIterator.next();
    ...
    this.gaugeValue.addListener(new ChangeListener()
    {
      public void changed(ObservableValue<? extends Number> paramAnonymousObservableValue, Number paramAnonymousNumber1, Number paramAnonymousNumber2)
      {
        ...
        RadialQuarterESkin.this.pointer.setRotate(RadialQuarterESkin.this.control.getRadialRange().ANGLE_RANGE);
        ...
        RadialQuarterESkin.this.pointerRotation.setAngle(-(paramAnonymousNumber2.doubleValue() - RadialQuarterESkin.this.control.getMinValue()) * RadialQuarterESkin.this.control.getAngleStep());
        RadialQuarterESkin.this.pointer.getTransforms().add(Transform.rotate(-RadialQuarterESkin.this.control.getRadialRange().ANGLE_RANGE + RadialQuarterESkin.this.control.getRadialRange().ROTATION_OFFSET, RadialQuarterESkin.this.rotationCenter.getX(), RadialQuarterESkin.this.rotationCenter.getY()));
        RadialQuarterESkin.this.pointer.getTransforms().add(RadialQuarterESkin.this.pointerRotation);
        RadialQuarterESkin.this.currentValue.set(paramAnonymousNumber2.doubleValue());
  ...
  protected void handleControlPropertyChanged(String paramString)
  {
    ...
    if (!"ANIMATION_DURATION".equals(paramString)) {
      ...
      else
      {
        ...
        {
          d = -45.0D - this.control.getMinValue() * this.control.getAngleStep();
  ...
  public void layoutChildren()
  {
    ...
    if (this.control.getScene() != null)
    {
      ...
      this.center = new Point2D(this.gaugeBounds.getWidth() * 0.265D, this.gaugeBounds.getHeight() * 0.5D);
  ...
  public void drawTitleAndUnit()
  {
    ...
    localText1.setX((d * 0.75D - localText1.getLayoutBounds().getWidth()) / 2.0D);
    ...
    localText2.setX((d * 0.75D - localText2.getLayoutBounds().getWidth()) / 2.0D);
...
/* Location:              /home/ivaneyvieira/git/inventario/Inventario.jar!/jfxtras/labs/internal/scene/control/skin/RadialQuarterESkin.class
