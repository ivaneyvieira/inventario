...
public class RadialHalfNSkin
  extends GaugeSkinBase<RadialHalfN, RadialHalfNBehavior>
{
  ...
  public RadialHalfNSkin(RadialHalfN paramRadialHalfN)
  {
    super(paramRadialHalfN, new RadialHalfNBehavior(paramRadialHalfN));
    this.control = paramRadialHalfN;
    ...
    this.ledTimer = new AnimationTimer()
    {
      ...
      {
        if (paramAnonymousLong > RadialHalfNSkin.this.lastLedTimerCall + RadialHalfNSkin.this.getBlinkInterval())
        {
          RadialHalfNSkin.access$180(RadialHalfNSkin.this, 1);
          if (RadialHalfNSkin.this.ledOnVisible) {
            RadialHalfNSkin.this.ledOn.setOpacity(1.0D);
          } else {
            RadialHalfNSkin.this.ledOn.setOpacity(0.0D);
          }
          RadialHalfNSkin.this.lastLedTimerCall = paramAnonymousLong;
        }
      }
    };
    ...
    this.userLedTimer = new AnimationTimer()
    {
      public void handle(long paramAnonymousLong)
      {
        if (paramAnonymousLong > RadialHalfNSkin.this.lastUserLedTimerCall + RadialHalfNSkin.this.getBlinkInterval())
        {
          RadialHalfNSkin.access$480(RadialHalfNSkin.this, 1);
          if (RadialHalfNSkin.this.userLedOnVisible) {
            RadialHalfNSkin.this.userLedOn.setOpacity(1.0D);
          } else {
            RadialHalfNSkin.this.userLedOn.setOpacity(0.0D);
          }
          RadialHalfNSkin.this.lastUserLedTimerCall = paramAnonymousLong;
        }
      }
    };
  ...
  private void addListeners()
  {
    this.control.getAreas().addListener(new InvalidationListener()
    {
      ...
      {
        RadialHalfNSkin.this.updateAreas();
        RadialHalfNSkin.this.drawCircularAreas(RadialHalfNSkin.this.control, RadialHalfNSkin.this.areas, RadialHalfNSkin.this.gaugeBounds);
      }
    });
    this.control.getSections().addListener(new InvalidationListener()
    {
      public void invalidated(Observable paramAnonymousObservable)
      {
        RadialHalfNSkin.this.updateSections();
        RadialHalfNSkin.this.drawCircularSections(RadialHalfNSkin.this.control, RadialHalfNSkin.this.sections, RadialHalfNSkin.this.gaugeBounds);
      }
    });
    this.control.getMarkers().addListener(new InvalidationListener()
    {
      public void invalidated(Observable paramAnonymousObservable)
      {
        RadialHalfNSkin.this.drawCircularIndicators(RadialHalfNSkin.this.control, RadialHalfNSkin.this.markers, RadialHalfNSkin.this.center, RadialHalfNSkin.this.gaugeBounds);
      }
    });
    this.control.valueProperty().addListener(new ChangeListener()
    {
      ...
      {
        RadialHalfNSkin.this.formerValue.set(paramAnonymousNumber1.doubleValue() < RadialHalfNSkin.this.control.getMinValue() ? RadialHalfNSkin.this.control.getMinValue() : paramAnonymousNumber1.doubleValue());
        if (RadialHalfNSkin.this.pointerRotation.getStatus() != Animation.Status.STOPPED) {
          RadialHalfNSkin.this.pointerRotation.stop();
        }
        if ((paramAnonymousNumber2.doubleValue() > paramAnonymousNumber1.doubleValue() - RadialHalfNSkin.this.control.getRedrawToleranceValue()) && (paramAnonymousNumber2.doubleValue() < paramAnonymousNumber1.doubleValue() + RadialHalfNSkin.this.control.getRedrawToleranceValue())) {
          return;
        }
        if (RadialHalfNSkin.this.control.isValueAnimationEnabled())
        {
          RadialHalfNSkin.this.pointerRotation.setFromAngle((RadialHalfNSkin.this.formerValue.doubleValue() - RadialHalfNSkin.this.control.getMinValue()) * RadialHalfNSkin.this.control.getAngleStep());
          RadialHalfNSkin.this.pointerRotation.setToAngle((paramAnonymousNumber2.doubleValue() - RadialHalfNSkin.this.control.getMinValue()) * RadialHalfNSkin.this.control.getAngleStep());
          RadialHalfNSkin.this.pointerRotation.setInterpolator(Interpolator.SPLINE(0.5D, 0.4D, 0.4D, 1.0D));
          RadialHalfNSkin.this.pointerRotation.play();
        }
        else
        {
          RadialHalfNSkin.this.pointer.setRotate((paramAnonymousNumber2.doubleValue() - RadialHalfNSkin.this.control.getMinValue()) * RadialHalfNSkin.this.control.getAngleStep());
        }
        RadialHalfNSkin.this.checkMarkers(RadialHalfNSkin.this.control, paramAnonymousNumber1.doubleValue(), paramAnonymousNumber2.doubleValue());
        InnerShadow localInnerShadow;
        DropShadow localDropShadow;
        Iterator localIterator;
        Section localSection;
        Shape localShape;
        if (RadialHalfNSkin.this.control.isSectionsHighlighting())
        {
          localInnerShadow = new InnerShadow();
          localInnerShadow.setBlurType(BlurType.GAUSSIAN);
          localDropShadow = new DropShadow();
          localDropShadow.setWidth(0.05D * RadialHalfNSkin.this.gaugeBounds.getWidth());
          localDropShadow.setHeight(0.05D * RadialHalfNSkin.this.gaugeBounds.getHeight());
          localDropShadow.setBlurType(BlurType.GAUSSIAN);
          localIterator = RadialHalfNSkin.this.control.getSections().iterator();
        ...
        if (RadialHalfNSkin.this.control.isAreasHighlighting())
        {
          localInnerShadow = new InnerShadow();
          localInnerShadow.setBlurType(BlurType.GAUSSIAN);
          localDropShadow = new DropShadow();
          ...
          localDropShadow.setHeight(0.05D * RadialHalfNSkin.this.gaugeBounds.getHeight());
          localDropShadow.setBlurType(BlurType.GAUSSIAN);
          localIterator = RadialHalfNSkin.this.control.getAreas().iterator();
          while (localIterator.hasNext())
          {
            localSection = (Section)localIterator.next();
    ...
    this.pointer.rotateProperty().addListener(new ChangeListener()
    {
      public void changed(ObservableValue<? extends Number> paramAnonymousObservableValue, Number paramAnonymousNumber1, Number paramAnonymousNumber2)
      {
        RadialHalfNSkin.this.currentValue.set(paramAnonymousNumber2.doubleValue() / RadialHalfNSkin.this.control.getAngleStep() + RadialHalfNSkin.this.control.getMinValue());
        if (RadialHalfNSkin.this.bargraphOff.isVisible())
        {
          int i = RadialHalfNSkin.this.noOfLeds - 1 - paramAnonymousNumber2.intValue() / 5;
          int j = RadialHalfNSkin.this.noOfLeds - 1 - paramAnonymousNumber1.intValue() / 5;
          int k = i > RadialHalfNSkin.this.noOfLeds ? RadialHalfNSkin.this.noOfLeds : i < 0 ? 0 : i;
          int m = j > RadialHalfNSkin.this.noOfLeds ? RadialHalfNSkin.this.noOfLeds : j < 0 ? 0 : j;
          int n = RadialHalfNSkin.this.noOfLeds - 1 - (int)(RadialHalfNSkin.this.control.getThreshold() * RadialHalfNSkin.this.control.getAngleStep() / 5.0D);
          int i1;
          if (Double.compare(RadialHalfNSkin.this.control.getValue(), RadialHalfNSkin.this.formerValue.doubleValue()) >= 0) {
            for (i1 = k; i1 <= m; i1++) {
              ((Shape)RadialHalfNSkin.this.ledsOn.get(i1)).setVisible(true);
            }
          } else {
            for (i1 = k; i1 >= m; i1--) {
              ((Shape)RadialHalfNSkin.this.ledsOn.get(i1)).setVisible(false);
            }
          }
          if (RadialHalfNSkin.this.control.isThresholdVisible())
          {
            ((Shape)RadialHalfNSkin.this.ledsOn.get(n)).setVisible(true);
            ((Shape)RadialHalfNSkin.this.ledsOn.get(n)).getStyleClass().clear();
            ((Shape)RadialHalfNSkin.this.ledsOn.get(n)).getStyleClass().add("bargraph-threshold");
          }
        }
        if (Double.compare(RadialHalfNSkin.this.currentValue.get(), RadialHalfNSkin.this.control.getMinMeasuredValue()) < 0) {
          RadialHalfNSkin.this.control.setMinMeasuredValue(RadialHalfNSkin.this.currentValue.get());
        } else if (Double.compare(RadialHalfNSkin.this.currentValue.get(), RadialHalfNSkin.this.control.getMaxMeasuredValue()) > 0) {
          RadialHalfNSkin.this.control.setMaxMeasuredValue(RadialHalfNSkin.this.currentValue.get());
        }
        if (RadialHalfNSkin.this.control.isThresholdBehaviorInverted()) {
          RadialHalfNSkin.this.control.setThresholdExceeded(RadialHalfNSkin.this.currentValue.get() < RadialHalfNSkin.this.control.getThreshold());
        } else {
          RadialHalfNSkin.this.control.setThresholdExceeded(RadialHalfNSkin.this.currentValue.get() > RadialHalfNSkin.this.control.getThreshold());
        }
        if (!RadialHalfNSkin.this.control.isThresholdExceeded()) {
          RadialHalfNSkin.this.ledOn.setOpacity(0.0D);
        }
      }
    });
  ...
  protected void handleControlPropertyChanged(String paramString)
  {
    ...
    {
      int i = this.noOfLeds - 1 - (int)(this.control.getThreshold() * this.control.getAngleStep() / 5.0D);
  ...
  public void layoutChildren()
  {
    ...
    if (this.control.getScene() != null)
    {
      ...
      this.center = new Point2D(this.gaugeBounds.getWidth() * 0.5D, this.gaugeBounds.getHeight() / 1.3D);
      drawFrame();
      drawBackground();
      drawCircularTrend(this.control, this.trend, this.gaugeBounds);
      updateSections();
  ...
  public RadialHalfN getSkinnable()
  {
    return this.control;
  }
  ...
  private void updateSections()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      double d5 = Gauge.RadialRange.RADIAL_180N.SECTIONS_OFFSET - d3 * this.control.getAngleStep() + this.control.getMinValue() * this.control.getAngleStep();
  ...
  private void updateAreas()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      double d6 = Gauge.RadialRange.RADIAL_180N.SECTIONS_OFFSET - d4 * this.control.getAngleStep() + this.control.getMinValue() * this.control.getAngleStep();
  ...
  public void drawFrame()
  {
    ...
    localPath1.getElements().add(new MoveTo(d2, 0.7692307692307693D * d3));
    localPath1.getElements().add(new CubicCurveTo(d2, 0.34615384615384615D * d3, 0.775D * d2, 0.0D, 0.5D * d2, 0.0D));
    localPath1.getElements().add(new CubicCurveTo(0.225D * d2, 0.0D, 0.0D, 0.34615384615384615D * d3, 0.0D, 0.7692307692307693D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.0D, 0.7692307692307693D * d3, 0.0D, d3, 0.0D, d3));
    localPath1.getElements().add(new LineTo(d2, d3));
    localPath1.getElements().add(new CubicCurveTo(d2, d3, d2, 0.7692307692307693D * d3, d2, 0.7692307692307693D * d3));
    ...
    localPath2.getElements().add(new MoveTo(0.07D * d2, 0.7615384615384615D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.07D * d2, 0.7615384615384615D * d3, 0.07D * d2, 0.8923076923076924D * d3, 0.07D * d2, 0.8923076923076924D * d3));
    localPath2.getElements().add(new LineTo(0.92D * d2, 0.8923076923076924D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.92D * d2, 0.8923076923076924D * d3, 0.92D * d2, 0.7615384615384615D * d3, 0.92D * d2, 0.7615384615384615D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.92D * d2, 0.4D * d3, 0.73D * d2, 0.1076923076923077D * d3, 0.495D * d2, 0.1076923076923077D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.26D * d2, 0.1076923076923077D * d3, 0.07D * d2, 0.4D * d3, 0.07D * d2, 0.7615384615384615D * d3));
    ...
    localPath3.getElements().add(new MoveTo(0.995D * d2, 0.7692307692307693D * d3));
    localPath3.getElements().add(new CubicCurveTo(0.995D * d2, 0.34615384615384615D * d3, 0.775D * d2, 0.007692307692307693D * d3, 0.5D * d2, 0.007692307692307693D * d3));
    localPath3.getElements().add(new CubicCurveTo(0.225D * d2, 0.007692307692307693D * d3, 0.005D * d2, 0.34615384615384615D * d3, 0.005D * d2, 0.7692307692307693D * d3));
    localPath3.getElements().add(new CubicCurveTo(0.005D * d2, 0.7692307692307693D * d3, 0.005D * d2, 0.9923076923076923D * d3, 0.005D * d2, 0.9923076923076923D * d3));
    localPath3.getElements().add(new LineTo(0.995D * d2, 0.9923076923076923D * d3));
    localPath3.getElements().add(new CubicCurveTo(0.995D * d2, 0.9923076923076923D * d3, 0.995D * d2, 0.7692307692307693D * d3, 0.995D * d2, 0.7692307692307693D * d3));
    ...
    case GLOSSY_METAL: 
      ...
      localPath4.getElements().add(new MoveTo(0.985D * d2, 0.7692307692307693D * d3));
      localPath4.getElements().add(new CubicCurveTo(0.985D * d2, 0.38461538461538464D * d3, 0.775D * d2, 0.023076923076923078D * d3, 0.5D * d2, 0.023076923076923078D * d3));
      localPath4.getElements().add(new CubicCurveTo(0.225D * d2, 0.023076923076923078D * d3, 0.015D * d2, 0.38461538461538464D * d3, 0.015D * d2, 0.7692307692307693D * d3));
      localPath4.getElements().add(new CubicCurveTo(0.015D * d2, 0.7692307692307693D * d3, 0.015D * d2, 0.9769230769230769D * d3, 0.015D * d2, 0.9769230769230769D * d3));
      localPath4.getElements().add(new LineTo(0.985D * d2, 0.9769230769230769D * d3));
      localPath4.getElements().add(new CubicCurveTo(0.985D * d2, 0.9769230769230769D * d3, 0.985D * d2, 0.7692307692307693D * d3, 0.985D * d2, 0.7692307692307693D * d3));
      localPath4.getElements().add(new ClosePath());
      LinearGradient localLinearGradient1 = new LinearGradient(0.5D * d2, 0.03076923076923077D * d3, 0.5D * d2, 0.9692307692307692D * d3, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, Color.color(0.9764705882D, 0.9764705882D, 0.9764705882D, 1.0D)), new Stop(0.23D, Color.color(0.7843137255D, 0.7647058824D, 0.7490196078D, 1.0D)), new Stop(0.34D, Color.color(0.8235294118D, 0.8235294118D, 0.8235294118D, 1.0D)), new Stop(0.65D, Color.color(0.1215686275D, 0.1215686275D, 0.1215686275D, 1.0D)), new Stop(0.84D, Color.color(0.7843137255D, 0.7607843137D, 0.7529411765D, 1.0D)), new Stop(1.0D, Color.color(0.7843137255D, 0.7607843137D, 0.7529411765D, 1.0D)) });
      ...
      localPath5.getElements().add(new MoveTo(0.935D * d2, 0.7692307692307693D * d3));
      localPath5.getElements().add(new CubicCurveTo(0.935D * d2, 0.43846153846153846D * d3, 0.77D * d2, 0.08461538461538462D * d3, 0.495D * d2, 0.08461538461538462D * d3));
      localPath5.getElements().add(new CubicCurveTo(0.22D * d2, 0.08461538461538462D * d3, 0.055D * d2, 0.43846153846153846D * d3, 0.055D * d2, 0.7692307692307693D * d3));
      localPath5.getElements().add(new CubicCurveTo(0.055D * d2, 0.7692307692307693D * d3, 0.055D * d2, 0.9153846153846154D * d3, 0.055D * d2, 0.9153846153846154D * d3));
      localPath5.getElements().add(new LineTo(0.935D * d2, 0.9153846153846154D * d3));
      localPath5.getElements().add(new CubicCurveTo(0.935D * d2, 0.9153846153846154D * d3, 0.935D * d2, 0.7692307692307693D * d3, 0.935D * d2, 0.7692307692307693D * d3));
      ...
      localPath6.getElements().add(new MoveTo(0.065D * d2, 0.7615384615384615D * d3));
      localPath6.getElements().add(new CubicCurveTo(0.065D * d2, 0.7615384615384615D * d3, 0.065D * d2, 0.9D * d3, 0.065D * d2, 0.9D * d3));
      localPath6.getElements().add(new LineTo(0.925D * d2, 0.9D * d3));
      localPath6.getElements().add(new CubicCurveTo(0.925D * d2, 0.9D * d3, 0.925D * d2, 0.7615384615384615D * d3, 0.925D * d2, 0.7615384615384615D * d3));
      localPath6.getElements().add(new CubicCurveTo(0.925D * d2, 0.3923076923076923D * d3, 0.73D * d2, 0.1D * d3, 0.495D * d2, 0.1D * d3));
      localPath6.getElements().add(new CubicCurveTo(0.26D * d2, 0.1D * d3, 0.065D * d2, 0.3923076923076923D * d3, 0.065D * d2, 0.7615384615384615D * d3));
      ...
      break;
    case DARK_GLOSSY: 
      LinearGradient localLinearGradient2 = new LinearGradient(0.805D * d2, 0.16923076923076924D * d3, 0.14031962568464537D * d2, 1.1918159604851613D * d3, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, Color.color(0.6745098039D, 0.6745098039D, 0.6784313725D, 1.0D)), new Stop(0.08D, Color.color(0.9960784314D, 0.9960784314D, 1.0D, 1.0D)), new Stop(0.52D, Color.BLACK), new Stop(0.55D, Color.color(0.0196078431D, 0.0235294118D, 0.0196078431D, 1.0D)), new Stop(0.84D, Color.color(0.9725490196D, 0.9803921569D, 0.9764705882D, 1.0D)), new Stop(0.99D, Color.color(0.7058823529D, 0.7058823529D, 0.7058823529D, 1.0D)), new Stop(1.0D, Color.color(0.6980392157D, 0.6980392157D, 0.6980392157D, 1.0D)) });
      localPath3.setFill(localLinearGradient2);
      localPath3.setStroke(null);
      Path localPath7 = new Path();
      localPath7.setFillRule(FillRule.EVEN_ODD);
      localPath7.getElements().add(new MoveTo(0.985D * d2, 0.7692307692307693D * d3));
      localPath7.getElements().add(new CubicCurveTo(0.985D * d2, 0.38461538461538464D * d3, 0.775D * d2, 0.023076923076923078D * d3, 0.5D * d2, 0.023076923076923078D * d3));
      localPath7.getElements().add(new CubicCurveTo(0.225D * d2, 0.023076923076923078D * d3, 0.015D * d2, 0.38461538461538464D * d3, 0.015D * d2, 0.7692307692307693D * d3));
      localPath7.getElements().add(new CubicCurveTo(0.015D * d2, 0.7692307692307693D * d3, 0.015D * d2, 0.9769230769230769D * d3, 0.015D * d2, 0.9769230769230769D * d3));
      localPath7.getElements().add(new LineTo(0.985D * d2, 0.9769230769230769D * d3));
      localPath7.getElements().add(new CubicCurveTo(0.985D * d2, 0.9769230769230769D * d3, 0.985D * d2, 0.7692307692307693D * d3, 0.985D * d2, 0.7692307692307693D * d3));
      localPath7.getElements().add(new ClosePath());
      LinearGradient localLinearGradient3 = new LinearGradient(0.0D, 0.03076923076923077D * d3, 0.0D, 0.9692307692307692D * d3, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, Color.color(0.2588235294D, 0.2588235294D, 0.2588235294D, 1.0D)), new Stop(0.41D, Color.color(0.2588235294D, 0.2588235294D, 0.2588235294D, 1.0D)), new Stop(1.0D, Color.BLACK) });
      ...
      localPath8.getElements().add(new MoveTo(0.985D * d2, 0.7692307692307693D * d3));
      localPath8.getElements().add(new CubicCurveTo(0.985D * d2, 0.38461538461538464D * d3, 0.775D * d2, 0.023076923076923078D * d3, 0.5D * d2, 0.023076923076923078D * d3));
      localPath8.getElements().add(new CubicCurveTo(0.225D * d2, 0.023076923076923078D * d3, 0.015D * d2, 0.38461538461538464D * d3, 0.015D * d2, 0.7692307692307693D * d3));
      localPath8.getElements().add(new CubicCurveTo(0.07D * d2, 0.5769230769230769D * d3, 0.285D * d2, 0.3923076923076923D * d3, 0.5D * d2, 0.3923076923076923D * d3));
      localPath8.getElements().add(new CubicCurveTo(0.735D * d2, 0.3923076923076923D * d3, 0.93D * d2, 0.5769230769230769D * d3, 0.985D * d2, 0.7692307692307693D * d3));
      localPath8.getElements().add(new ClosePath());
      LinearGradient localLinearGradient4 = new LinearGradient(0.0D, 0.03076923076923077D * d3, 0.0D, 0.7461538461538462D * d3, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, Color.color(1.0D, 1.0D, 1.0D, 1.0D)), new Stop(0.26D, Color.color(1.0D, 1.0D, 1.0D, 0.737254902D)), new Stop(1.0D, Color.color(1.0D, 1.0D, 1.0D, 0.0D)) });
      ...
      localPath9.getElements().add(new MoveTo(0.065D * d2, 0.7615384615384615D * d3));
      localPath9.getElements().add(new CubicCurveTo(0.065D * d2, 0.7615384615384615D * d3, 0.065D * d2, 0.9D * d3, 0.065D * d2, 0.9D * d3));
      localPath9.getElements().add(new LineTo(0.925D * d2, 0.9D * d3));
      localPath9.getElements().add(new CubicCurveTo(0.925D * d2, 0.9D * d3, 0.925D * d2, 0.7615384615384615D * d3, 0.925D * d2, 0.7615384615384615D * d3));
      localPath9.getElements().add(new CubicCurveTo(0.925D * d2, 0.3923076923076923D * d3, 0.73D * d2, 0.1D * d3, 0.495D * d2, 0.1D * d3));
      localPath9.getElements().add(new CubicCurveTo(0.26D * d2, 0.1D * d3, 0.065D * d2, 0.3923076923076923D * d3, 0.065D * d2, 0.7615384615384615D * d3));
      localPath9.getElements().add(new ClosePath());
      LinearGradient localLinearGradient5 = new LinearGradient(0.775D * d2, 0.26153846153846155D * d3, 0.17435126671722642D * d2, 1.1539072912819428D * d3, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, Color.color(0.6745098039D, 0.6745098039D, 0.6784313725D, 1.0D)), new Stop(0.07D, Color.color(0.9568627451D, 0.9568627451D, 0.9607843137D, 1.0D)), new Stop(0.52D, Color.BLACK), new Stop(0.55D, Color.color(0.0196078431D, 0.0235294118D, 0.0196078431D, 1.0D)), new Stop(0.9D, Color.color(0.9725490196D, 0.9803921569D, 0.9764705882D, 1.0D)), new Stop(0.92D, Color.color(0.9058823529D, 0.9137254902D, 0.9098039216D, 1.0D)), new Stop(1.0D, Color.color(0.6980392157D, 0.6980392157D, 0.6980392157D, 1.0D)) });
  ...
  public void drawBackground()
  {
    ...
    Path localPath1 = new Path();
    localPath1.setFillRule(FillRule.EVEN_ODD);
    localPath1.getElements().add(new MoveTo(0.075D * d2, 0.7615384615384615D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.075D * d2, 0.7615384615384615D * d3, 0.075D * d2, 0.8846153846153846D * d3, 0.075D * d2, 0.8846153846153846D * d3));
    localPath1.getElements().add(new LineTo(0.915D * d2, 0.8846153846153846D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.915D * d2, 0.8846153846153846D * d3, 0.915D * d2, 0.7615384615384615D * d3, 0.915D * d2, 0.7615384615384615D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.915D * d2, 0.4076923076923077D * d3, 0.725D * d2, 0.11538461538461539D * d3, 0.495D * d2, 0.11538461538461539D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.265D * d2, 0.11538461538461539D * d3, 0.075D * d2, 0.4076923076923077D * d3, 0.075D * d2, 0.7615384615384615D * d3));
    localPath1.getElements().add(new ClosePath());
    localPath1.setStroke(null);
    Path localPath2 = new Path();
    localPath2.setFillRule(FillRule.EVEN_ODD);
    localPath2.getElements().add(new MoveTo(0.075D * d2, 0.7615384615384615D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.075D * d2, 0.7615384615384615D * d3, 0.075D * d2, 0.8846153846153846D * d3, 0.075D * d2, 0.8846153846153846D * d3));
    localPath2.getElements().add(new LineTo(0.915D * d2, 0.8846153846153846D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.915D * d2, 0.8846153846153846D * d3, 0.915D * d2, 0.7615384615384615D * d3, 0.915D * d2, 0.7615384615384615D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.915D * d2, 0.4076923076923077D * d3, 0.725D * d2, 0.11538461538461539D * d3, 0.495D * d2, 0.11538461538461539D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.265D * d2, 0.11538461538461539D * d3, 0.075D * d2, 0.4076923076923077D * d3, 0.075D * d2, 0.7615384615384615D * d3));
    localPath2.getElements().add(new ClosePath());
  ...
  public void drawTitleAndUnit()
  {
    ...
    localText1.setY(0.27D * d2 + localText1.getLayoutBounds().getHeight());
    ...
    localText2.setY(0.32D * d2 + localText2.getLayoutBounds().getHeight());
  ...
  public void drawGlowOff()
  {
    ...
    Path localPath1 = new Path();
    localPath1.setFillRule(FillRule.EVEN_ODD);
    localPath1.getElements().add(new MoveTo(0.1D * d2, 0.7615384615384615D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.1D * d2, 0.4153846153846154D * d3, 0.275D * d2, 0.15384615384615385D * d3, 0.495D * d2, 0.15384615384615385D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.715D * d2, 0.15384615384615385D * d3, 0.89D * d2, 0.4153846153846154D * d3, 0.89D * d2, 0.7615384615384615D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.89D * d2, 0.7846153846153846D * d3, 0.89D * d2, 0.8461538461538461D * d3, 0.89D * d2, 0.8461538461538461D * d3));
    localPath1.getElements().add(new LineTo(0.1D * d2, 0.8461538461538461D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.1D * d2, 0.8461538461538461D * d3, 0.1D * d2, 0.7846153846153846D * d3, 0.1D * d2, 0.7615384615384615D * d3));
    localPath1.getElements().add(new ClosePath());
    localPath1.getElements().add(new MoveTo(0.075D * d2, 0.7615384615384615D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.075D * d2, 0.7846153846153846D * d3, 0.075D * d2, 0.8461538461538461D * d3, 0.075D * d2, 0.8461538461538461D * d3));
    localPath1.getElements().add(new LineTo(0.075D * d2, 0.8846153846153846D * d3));
    localPath1.getElements().add(new LineTo(0.915D * d2, 0.8846153846153846D * d3));
    localPath1.getElements().add(new LineTo(0.915D * d2, 0.8461538461538461D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.915D * d2, 0.8461538461538461D * d3, 0.915D * d2, 0.7846153846153846D * d3, 0.915D * d2, 0.7615384615384615D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.915D * d2, 0.4076923076923077D * d3, 0.725D * d2, 0.11538461538461539D * d3, 0.495D * d2, 0.11538461538461539D * d3));
    localPath1.getElements().add(new CubicCurveTo(0.265D * d2, 0.11538461538461539D * d3, 0.075D * d2, 0.4076923076923077D * d3, 0.075D * d2, 0.7615384615384615D * d3));
    localPath1.getElements().add(new ClosePath());
    ...
    Path localPath2 = new Path();
    localPath2.setFillRule(FillRule.EVEN_ODD);
    localPath2.getElements().add(new MoveTo(0.13D * d2, 0.5153846153846153D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.195D * d2, 0.2846153846153846D * d3, 0.335D * d2, 0.15384615384615385D * d3, 0.495D * d2, 0.15384615384615385D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.495D * d2, 0.15384615384615385D * d3, 0.495D * d2, 0.11538461538461539D * d3, 0.495D * d2, 0.11538461538461539D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.325D * d2, 0.11538461538461539D * d3, 0.18D * d2, 0.26153846153846155D * d3, 0.11D * d2, 0.5D * d3));
    localPath2.getElements().add(new CubicCurveTo(0.11D * d2, 0.5D * d3, 0.13D * d2, 0.5153846153846153D * d3, 0.13D * d2, 0.5153846153846153D * d3));
    localPath2.getElements().add(new ClosePath());
    RadialGradient localRadialGradient = new RadialGradient(0.0D, 0.0D, 0.26D * d2, 0.23846153846153847D * d3, 0.24D * d2, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, Color.color(1.0D, 1.0D, 1.0D, 0.4D)), new Stop(1.0D, Color.color(1.0D, 1.0D, 1.0D, 0.0D)) });
  ...
  public void drawGlowOn()
  {
    ...
    localPath1.getElements().add(new CubicCurveTo(0.265D * d2, 0.11538461538461539D * d3, 0.075D * d2, 0.4076923076923077D * d3, 0.075D * d2, 0.7615384615384615D * d3));
    localPath1.getElements().add(new ClosePath());
    RadialGradient localRadialGradient = new RadialGradient(0.0D, 0.0D, 0.5D * d2, 0.5D * d3, 0.4158878504672897D * d2, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, (Color)this.glowColors.get(0)), new Stop(0.91D, (Color)this.glowColors.get(1)), new Stop(0.96D, (Color)this.glowColors.get(2)), new Stop(1.0D, (Color)this.glowColors.get(3)) });
    ...
    localPath2.getElements().add(new CubicCurveTo(0.11D * d2, 0.5D * d3, 0.13D * d2, 0.5153846153846153D * d3, 0.13D * d2, 0.5153846153846153D * d3));
    localPath2.getElements().add(new ClosePath());
    localPath2.setFill(new RadialGradient(0.0D, 0.0D, 0.26635514018691586D * d2, 0.16355140186915887D * d3, 0.23598130841121495D * d2, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, Color.color(1.0D, 1.0D, 1.0D, 0.4D)), new Stop(1.0D, Color.color(1.0D, 1.0D, 1.0D, 0.0D)) }));
    localPath2.setStroke(null);
  ...
  public void drawIndicators()
  {
    ...
    this.markers.getTransforms().add(Transform.rotate(this.control.getRadialRange().ROTATION_OFFSET, this.center.getX(), this.center.getY()));
    this.markers.getTransforms().add(Transform.rotate(-this.control.getMinValue() * this.control.getAngleStep(), this.center.getX(), this.center.getY()));
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((Double.compare(localMarker.getValue(), this.control.getMinValue()) >= 0) && (Double.compare(localMarker.getValue(), this.control.getMaxValue()) <= 0))
      {
        ...
        localGroup.getTransforms().add(Transform.rotate(localMarker.getValue() * this.control.getAngleStep(), this.center.getX(), this.center.getY()));
  ...
  public void drawMinMeasuredIndicator()
  {
    ...
    Path localPath = createTriangleShape(0.03D * d2, 0.035D * d2, true);
    localPath.setFill(Color.color(0.0D, 0.0D, 0.8D));
    localPath.setStroke(null);
    localPath.setTranslateX(0.485D * d2);
    localPath.setTranslateY(0.1D * d2);
  ...
  public void drawForeground()
  {
    ...
    case TYPE2: 
      ...
      localPath.getElements().add(new MoveTo(0.495D * d2, 0.5923076923076923D * d3));
      localPath.getElements().add(new CubicCurveTo(0.65D * d2, 0.47692307692307695D * d3, 0.73D * d2, 0.47692307692307695D * d3, 0.87D * d2, 0.47692307692307695D * d3));
      localPath.getElements().add(new CubicCurveTo(0.765D * d2, 0.16153846153846155D * d3, 0.52D * d2, 0.023076923076923078D * d3, 0.31D * d2, 0.18461538461538463D * d3));
      localPath.getElements().add(new CubicCurveTo(0.155D * d2, 0.3076923076923077D * d3, 0.075D * d2, 0.5307692307692308D * d3, 0.08D * d2, 0.7692307692307693D * d3));
      localPath.getElements().add(new CubicCurveTo(0.085D * d2, 0.8615384615384616D * d3, 0.35D * d2, 0.7076923076923077D * d3, 0.495D * d2, 0.5923076923076923D * d3));
      localPath.getElements().add(new ClosePath());
      localPath.setFill(new LinearGradient(0.31D * d2, 0.19230769230769232D * d3, 0.4915961998958187D * d2, 0.7406193995005341D * d3, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, Color.color(1.0D, 1.0D, 1.0D, 0.2470588235D)), new Stop(1.0D, Color.color(1.0D, 1.0D, 1.0D, 0.0470588235D)) }));
      localPath.setStroke(null);
      this.foreground.getChildren().addAll(new Node[] { localPath });
      break;
    case TYPE3: 
      localPath.setFillRule(FillRule.EVEN_ODD);
      localPath.getElements().add(new MoveTo(0.08D * d2, 0.7692307692307693D * d3));
      localPath.getElements().add(new CubicCurveTo(0.205D * d2, 0.8384615384615385D * d3, 0.455D * d2, 0.8461538461538461D * d3, 0.495D * d2, 0.8461538461538461D * d3));
      localPath.getElements().add(new CubicCurveTo(0.53D * d2, 0.8461538461538461D * d3, 0.79D * d2, 0.8461538461538461D * d3, 0.91D * d2, 0.7692307692307693D * d3));
      localPath.getElements().add(new CubicCurveTo(0.91D * d2, 0.4076923076923077D * d3, 0.735D * d2, 0.11538461538461539D * d3, 0.495D * d2, 0.11538461538461539D * d3));
      localPath.getElements().add(new CubicCurveTo(0.255D * d2, 0.11538461538461539D * d3, 0.08D * d2, 0.4076923076923077D * d3, 0.08D * d2, 0.7692307692307693D * d3));
      localPath.getElements().add(new ClosePath());
      localPath.setFill(new LinearGradient(0.495D * d2, 0.13076923076923078D * d3, 0.495D * d2, 0.8461538461538461D * d3, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, Color.color(1.0D, 1.0D, 1.0D, 0.2470588235D)), new Stop(1.0D, Color.color(1.0D, 1.0D, 1.0D, 0.0470588235D)) }));
      localPath.setStroke(null);
      this.foreground.getChildren().addAll(new Node[] { localPath });
      break;
    case TYPE4: 
    ...
    default: 
      localPath.setFillRule(FillRule.EVEN_ODD);
      localPath.getElements().add(new MoveTo(0.08D * d2, 0.7692307692307693D * d3));
      localPath.getElements().add(new CubicCurveTo(0.2D * d2, 0.676923076923077D * d3, 0.33D * d2, 0.6230769230769231D * d3, 0.495D * d2, 0.6230769230769231D * d3));
      localPath.getElements().add(new CubicCurveTo(0.665D * d2, 0.6230769230769231D * d3, 0.785D * d2, 0.6692307692307692D * d3, 0.91D * d2, 0.7692307692307693D * d3));
      localPath.getElements().add(new CubicCurveTo(0.91D * d2, 0.4076923076923077D * d3, 0.735D * d2, 0.11538461538461539D * d3, 0.495D * d2, 0.11538461538461539D * d3));
      localPath.getElements().add(new CubicCurveTo(0.255D * d2, 0.11538461538461539D * d3, 0.08D * d2, 0.4076923076923077D * d3, 0.08D * d2, 0.7692307692307693D * d3));
      localPath.getElements().add(new ClosePath());
      localPath.setFill(new LinearGradient(0.495D * d2, 0.12307692307692308D * d3, 0.495D * d2, 0.7461538461538462D * d3, false, CycleMethod.NO_CYCLE, new Stop[] { new Stop(0.0D, Color.color(1.0D, 1.0D, 1.0D, 0.2980392157D)), new Stop(1.0D, Color.color(1.0D, 1.0D, 1.0D, 0.0941176471D)) }));
      localPath.setStroke(null);
      this.foreground.getChildren().addAll(new Node[] { localPath });
    }
  }
...
/* Location:              /home/ivaneyvieira/git/inventario/Inventario.jar!/jfxtras/labs/internal/scene/control/skin/RadialHalfNSkin.class
