...
public class RadialQuarterSSkin
  extends GaugeSkinBase<RadialQuarterS, RadialQuarterSBehavior>
{
  ...
  public RadialQuarterSSkin(RadialQuarterS paramRadialQuarterS)
  {
    super(paramRadialQuarterS, new RadialQuarterSBehavior(paramRadialQuarterS));
    this.control = paramRadialQuarterS;
    ...
    this.ledTimer = new AnimationTimer()
    {
      ...
      {
        if (paramAnonymousLong > RadialQuarterSSkin.this.lastLedTimerCall + RadialQuarterSSkin.this.getBlinkInterval())
        {
          RadialQuarterSSkin.access$180(RadialQuarterSSkin.this, 1);
          if (RadialQuarterSSkin.this.ledOnVisible) {
            RadialQuarterSSkin.this.ledOn.setOpacity(1.0D);
          } else {
            RadialQuarterSSkin.this.ledOn.setOpacity(0.0D);
          }
          RadialQuarterSSkin.this.lastLedTimerCall = paramAnonymousLong;
        }
      }
    };
    ...
    this.userLedTimer = new AnimationTimer()
    {
      public void handle(long paramAnonymousLong)
      {
        if (paramAnonymousLong > RadialQuarterSSkin.this.lastUserLedTimerCall + RadialQuarterSSkin.this.getBlinkInterval())
        {
          RadialQuarterSSkin.access$480(RadialQuarterSSkin.this, 1);
          if (RadialQuarterSSkin.this.userLedOnVisible) {
            RadialQuarterSSkin.this.userLedOn.setOpacity(1.0D);
          } else {
            RadialQuarterSSkin.this.userLedOn.setOpacity(0.0D);
          }
          RadialQuarterSSkin.this.lastUserLedTimerCall = paramAnonymousLong;
        }
      }
    };
  ...
  private void addListeners()
  {
    this.control.getAreas().addListener(new InvalidationListener()
    {
      ...
      {
        RadialQuarterSSkin.this.updateAreas();
        RadialQuarterSSkin.this.drawCircularAreas(RadialQuarterSSkin.this.control, RadialQuarterSSkin.this.areas, RadialQuarterSSkin.this.gaugeBounds);
      }
    });
    this.control.getSections().addListener(new InvalidationListener()
    {
      public void invalidated(Observable paramAnonymousObservable)
      {
        RadialQuarterSSkin.this.updateSections();
        RadialQuarterSSkin.this.drawCircularSections(RadialQuarterSSkin.this.control, RadialQuarterSSkin.this.sections, RadialQuarterSSkin.this.gaugeBounds);
      }
    });
    this.control.getMarkers().addListener(new InvalidationListener()
    {
      public void invalidated(Observable paramAnonymousObservable)
      {
        RadialQuarterSSkin.this.drawCircularIndicators(RadialQuarterSSkin.this.control, RadialQuarterSSkin.this.markers, RadialQuarterSSkin.this.center, RadialQuarterSSkin.this.gaugeBounds);
      }
    });
    this.control.valueProperty().addListener(new ChangeListener()
    {
      ...
      {
        if (RadialQuarterSSkin.this.rotationAngleTimeline.getStatus() != Animation.Status.STOPPED) {
          RadialQuarterSSkin.this.rotationAngleTimeline.stop();
        }
        if ((paramAnonymousNumber2.doubleValue() > paramAnonymousNumber1.doubleValue() - RadialQuarterSSkin.this.control.getRedrawToleranceValue()) && (paramAnonymousNumber2.doubleValue() < paramAnonymousNumber1.doubleValue() + RadialQuarterSSkin.this.control.getRedrawToleranceValue())) {
          return;
        }
        Object localObject1;
        Object localObject2;
        if (RadialQuarterSSkin.this.control.isValueAnimationEnabled())
        {
          localObject1 = new KeyValue(RadialQuarterSSkin.this.gaugeValue, paramAnonymousNumber2, Interpolator.SPLINE(0.5D, 0.4D, 0.4D, 1.0D));
          localObject2 = new KeyFrame(Duration.millis(RadialQuarterSSkin.this.control.getAnimationDuration()), new KeyValue[] { localObject1 });
          RadialQuarterSSkin.this.rotationAngleTimeline = new Timeline();
          RadialQuarterSSkin.this.rotationAngleTimeline.getKeyFrames().add(localObject2);
          RadialQuarterSSkin.this.rotationAngleTimeline.play();
        }
        else
        {
          RadialQuarterSSkin.this.pointerRotation.setPivotX(RadialQuarterSSkin.this.center.getX());
          RadialQuarterSSkin.this.pointerRotation.setPivotY(RadialQuarterSSkin.this.center.getY());
          RadialQuarterSSkin.this.pointerRotation.setAngle((paramAnonymousNumber2.doubleValue() - RadialQuarterSSkin.this.control.getMinValue()) * RadialQuarterSSkin.this.control.getAngleStep());
          RadialQuarterSSkin.this.pointer.getTransforms().add(Transform.rotate(RadialQuarterSSkin.this.control.getRadialRange().ROTATION_OFFSET, RadialQuarterSSkin.this.center.getX(), RadialQuarterSSkin.this.center.getY()));
          RadialQuarterSSkin.this.pointer.getTransforms().add(RadialQuarterSSkin.this.pointerRotation);
        }
        RadialQuarterSSkin.this.checkMarkers(RadialQuarterSSkin.this.control, paramAnonymousNumber1.doubleValue(), paramAnonymousNumber2.doubleValue());
        Iterator localIterator;
        Section localSection;
        Shape localShape;
        if (RadialQuarterSSkin.this.control.isSectionsHighlighting())
        {
          localObject1 = new InnerShadow();
          ((InnerShadow)localObject1).setBlurType(BlurType.GAUSSIAN);
          localObject2 = new DropShadow();
          ((DropShadow)localObject2).setWidth(0.05D * RadialQuarterSSkin.this.gaugeBounds.getWidth());
          ((DropShadow)localObject2).setHeight(0.05D * RadialQuarterSSkin.this.gaugeBounds.getHeight());
          ((DropShadow)localObject2).setBlurType(BlurType.GAUSSIAN);
          localIterator = RadialQuarterSSkin.this.control.getSections().iterator();
        ...
        if (RadialQuarterSSkin.this.control.isAreasHighlighting())
        {
          localObject1 = new InnerShadow();
          ((InnerShadow)localObject1).setBlurType(BlurType.GAUSSIAN);
          localObject2 = new DropShadow();
          ...
          ((DropShadow)localObject2).setHeight(0.05D * RadialQuarterSSkin.this.gaugeBounds.getHeight());
          ((DropShadow)localObject2).setBlurType(BlurType.GAUSSIAN);
          localIterator = RadialQuarterSSkin.this.control.getAreas().iterator();
          while (localIterator.hasNext())
          {
            localSection = (Section)localIterator.next();
    ...
    this.gaugeValue.addListener(new ChangeListener()
    {
      public void changed(ObservableValue<? extends Number> paramAnonymousObservableValue, Number paramAnonymousNumber1, Number paramAnonymousNumber2)
      {
        RadialQuarterSSkin.this.pointer.getTransforms().clear();
        RadialQuarterSSkin.this.pointerRotation.setPivotX(RadialQuarterSSkin.this.center.getX());
        RadialQuarterSSkin.this.pointerRotation.setPivotY(RadialQuarterSSkin.this.center.getY());
        RadialQuarterSSkin.this.pointerRotation.setAngle(-(paramAnonymousNumber2.doubleValue() - RadialQuarterSSkin.this.control.getMinValue()) * RadialQuarterSSkin.this.control.getAngleStep());
        RadialQuarterSSkin.this.pointer.getTransforms().add(Transform.rotate(RadialQuarterSSkin.this.control.getRadialRange().ROTATION_OFFSET, RadialQuarterSSkin.this.center.getX(), RadialQuarterSSkin.this.center.getY()));
        RadialQuarterSSkin.this.pointer.getTransforms().add(RadialQuarterSSkin.this.pointerRotation);
        RadialQuarterSSkin.this.currentValue.set(paramAnonymousNumber2.doubleValue());
        RadialQuarterSSkin.this.currentLcdValue.set(RadialQuarterSSkin.this.control.isLcdValueCoupled() ? RadialQuarterSSkin.this.currentValue.get() : RadialQuarterSSkin.this.control.getLcdValue());
        if (Double.compare(RadialQuarterSSkin.this.currentValue.get(), RadialQuarterSSkin.this.control.getMinMeasuredValue()) < 0) {
          RadialQuarterSSkin.this.control.setMinMeasuredValue(RadialQuarterSSkin.this.currentValue.get());
        } else if (Double.compare(RadialQuarterSSkin.this.currentValue.get(), RadialQuarterSSkin.this.control.getMaxMeasuredValue()) > 0) {
          RadialQuarterSSkin.this.control.setMaxMeasuredValue(RadialQuarterSSkin.this.currentValue.get());
        }
        if (RadialQuarterSSkin.this.control.isThresholdBehaviorInverted()) {
          RadialQuarterSSkin.this.control.setThresholdExceeded(RadialQuarterSSkin.this.currentValue.get() < RadialQuarterSSkin.this.control.getThreshold());
        } else {
          RadialQuarterSSkin.this.control.setThresholdExceeded(RadialQuarterSSkin.this.currentValue.get() > RadialQuarterSSkin.this.control.getThreshold());
        }
        if (!RadialQuarterSSkin.this.control.isThresholdExceeded()) {
          RadialQuarterSSkin.this.ledOn.setOpacity(0.0D);
        }
        if (RadialQuarterSSkin.this.control.isLcdVisible()) {
          RadialQuarterSSkin.this.drawLcdContent();
        }
      }
    });
  }
  ...
  protected void handleControlPropertyChanged(String paramString)
  {
    ...
    if (!"ANIMATION_DURATION".equals(paramString)) {
      ...
      else
      {
        ...
        {
          d = 180.0D + this.control.getRadialRange().ROTATION_OFFSET;
          this.minMeasured.getTransforms().clear();
          this.minMeasured.getTransforms().add(Transform.rotate(d - (this.control.getMinMeasuredValue() - this.control.getMinValue()) * this.control.getAngleStep(), this.center.getX(), this.center.getY()));
        }
        else if ("MAX_MEASURED_VALUE".equals(paramString))
        {
          d = 180.0D + this.control.getRadialRange().ROTATION_OFFSET;
          this.maxMeasured.getTransforms().clear();
          this.maxMeasured.getTransforms().add(Transform.rotate(d - (this.control.getMaxMeasuredValue() - this.control.getMinValue()) * this.control.getAngleStep(), this.center.getX(), this.center.getY()));
        }
  ...
  public void layoutChildren()
  {
    ...
    if (this.control.getScene() != null)
    {
      ...
      this.center = new Point2D(this.gaugeBounds.getWidth() * 0.5D, this.gaugeBounds.getHeight() * 0.265D);
      drawCircularFrame(this.control, this.frame, this.gaugeBounds);
      drawCircularBackground(this.control, this.background, this.gaugeBounds);
      drawCircularTrend(this.control, this.trend, this.gaugeBounds);
      updateSections();
  ...
  public RadialQuarterS getSkinnable()
  {
    return this.control;
  }
  ...
  private void updateAreas()
  {
    ...
    Rectangle localRectangle = new Rectangle(0.0D, 0.0D, this.control.getPrefWidth(), this.control.getPrefHeight() / 2.2D);
  ...
  public void drawThreshold()
  {
    ...
    Path localPath = createTriangleShape(0.03D * d2, 0.03D * d3, true);
    ...
    localPath.setTranslateY(0.72D * d3);
    this.threshold.getChildren().addAll(new Node[] { localPath });
    double d4 = 180.0D + this.control.getRadialRange().ROTATION_OFFSET;
    this.threshold.getTransforms().clear();
    this.threshold.getTransforms().add(Transform.rotate(d4 - (this.control.getThreshold() - this.control.getMinValue()) * this.control.getAngleStep(), this.center.getX(), this.center.getY()));
  }
  ...
  public void drawMinMeasuredIndicator()
  {
    ...
    Path localPath = createTriangleShape(0.03D * d2, 0.035D * d3, false);
    localPath.setFill(Color.color(0.0D, 0.0D, 0.8D));
    localPath.setStroke(null);
    localPath.setTranslateX(0.485D * d2);
    localPath.setTranslateY(0.75D * d3);
    this.minMeasured.getChildren().add(localPath);
    double d4 = 180.0D + this.control.getRadialRange().ROTATION_OFFSET;
    this.minMeasured.getTransforms().clear();
    this.minMeasured.getTransforms().add(Transform.rotate(d4 - (this.control.getMinMeasuredValue() - this.control.getMinValue()) * this.control.getAngleStep(), this.center.getX(), this.center.getY()));
  }
  ...
  public void drawMaxMeasuredIndicator()
  {
    ...
    double d4 = 180.0D + this.control.getRadialRange().ROTATION_OFFSET;
    this.maxMeasured.getTransforms().clear();
    this.maxMeasured.getTransforms().add(Transform.rotate(d4 - (this.control.getMaxMeasuredValue() - this.control.getMinValue()) * this.control.getAngleStep(), this.center.getX(), this.center.getY()));
  }
  ...
  public void drawPointer()
  {
    ...
    localPath1.setTranslateY(-d1 * 0.465D);
    localPath2.setTranslateY(-d1 * 0.465D);
...
/* Location:              /home/ivaneyvieira/git/inventario/Inventario.jar!/jfxtras/labs/internal/scene/control/skin/RadialQuarterSSkin.class
